    ...
    <div className={`min-h-screen ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-800'}`}>
      <div className="container mx-auto py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className={`p-6 rounded-lg shadow-md ${isDarkMode ? 'bg-gray-800' : 'bg-blue-200'}`}>
            <FaHandshake className="text-5xl mx-auto mb-4" />
            <h2 className="text-2xl font-semibold mb-4 text-center">{isDarkMode ? 'Our Dark Mission' : 'Our Mission'}</h2>
          ...
          <div className={`p-6 rounded-lg shadow-md ${isDarkMode ? 'bg-gray-800' : 'bg-green-200'}`}>
            <FaBullseye className="text-5xl mx-auto mb-4" />
            <h2 className="text-2xl font-semibold mb-4 text-center">{isDarkMode ? 'Our Dark Vision' : 'Our Vision'}</h2>
            <p className="leading-relaxed">
              {isDarkMode
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className={`rounded-lg shadow-md p-6 ${isDarkMode ? 'bg-yellow-800' : 'bg-yellow-200'}`}>
            ...
            <div className={`rounded-lg shadow-md p-6 ${isDarkMode ? 'bg-pink-800' : 'bg-pink-200'}`}>
              <FaUserTie className="text-3xl mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2 text-center">Y</h3>
              <p className="text-center">COO</p>
            </div>
            <div className={`rounded-lg shadow-md p-6 ${isDarkMode ? 'bg-purple-800' : 'bg-purple-200'}`}>
              <FaUserTie className="text-3xl mx-auto mb-4" />
      ...
      <button
        className={`fixed bottom-4 right-4 p-2 rounded-full border border-gray-300 focus:outline-none ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-800'}`}
